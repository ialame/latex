...
public class TD7bis{ // Exemple d'exécution en fin de fichier, comme d'hab.
 	...
 	*/
 	...
 	Progression : I(k) et ... et t_k permutée avec ... ==> I(k+1) */
 		int k = ...; // I(k)
 		while (...){ permuter(T,...,...); // I(k+1)
 			k = k+1; // I(k)
 		}
 		// I(k) et ... Donc T contient ses valeurs dans l'ordre inverse (c'est la sortie S)	
 	}
